...
/// A controller used to notify an [CommingleMoneyField] about math button presses.
final class AwesomeMoneyFieldMathController {
  /// The current listener for math button presses, [CommingleMoneyField] assigns itself as the listener automatically.
  AwesomeMoneyFieldMathListener? listener;

  /// Notifies listener ([CommingleMoneyField]) of [button] press.
